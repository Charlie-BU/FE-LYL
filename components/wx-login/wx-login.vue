<template>
	<view>
		<u-popup :closeOnClickOverlay="false" :show="loginShow" @close="loginShow = false" mode="center"
			:customStyle="customAlertStyle" bgColor="transparent" :overlayOpacity="0.6">
			<view class="weixin-login">
				<view class="weixin-login-info">
					...
					<button :disabled="loginDisabled" type="primary" open-type="getPhoneNumber"
						@getphonenumber="getPhoneNumber" class="weixin-login-btn">手机号快捷登录</button>
				</view>
				<view class="weixin-login-bot">
					<image src="https://liyilian.oss-cn-hangzhou.aliyuncs.com/static/common/alert-close.png"
