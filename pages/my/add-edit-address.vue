		...
		<block v-else>
			<view class="form">
				<view class="form-row">
					<text>收货人</text>
					<view class="right">
						<u-input border="none"  placeholder="姓名"
				...
				<view class="form-row">
					<text>手机号码</text>
					<view class="right">
						<u-input border="none"  placeholder="手机号码"
							placeholderClass="placeholder28" 
							:placeholderStyle="placeholderStyle"
							type="text" 
							fontSize="28rpx" 
				...
				<view class="form-row">
					...
					<view class="right" @click="openAddres()">
						<text class="text black" v-if="form.province && form.city && form.district">{{form.province + form.city + form.district}}</text>
						<text class="text" v-else>省、市、区</text>
						<image src="@/static/common/dizhi.png" mode="widthFix" class="icon-img" />
					</view>
				</view>
				<view class="form-row">
				...
				<view class="default-row">
					...
					<image 
					@click="changeDefault"
					:src="form.is_default==1?'/static/common/checkbox_select.png':'/static/common/checkbox_unselect.png'" 
					mode="widthFix" 
					class="icon-img"/>
				</view>
			</view>
			...
			<view class="wx-location" @click="chooseAddress" v-if="form.id == 0">
				<image src="@/static/common/weixin.png" mode="widthFix"></image>
				<text>从微信获取新地址</text>
			</view>
			<!-- #endif -->
			<view class="submit">
