				...
				<view class="top-images">
					...
					<view class="images">
						<view class="img-item" v-for="(item,index) in default_heads" :key="index">
							<view class="img-con">
								<image :src="getFullUrl(item)" mode="widthFix" class="info-img" @click="changeTempIndex(index)"/>
								<image src="@/static/my/img-sel.png" mode="widthFix" class="sel-img" v-if="temp_index == index"/>
							</view>
						</view>
					</view>
				</view>
