			...
			<view class="user-top">
				...
				<view class="user-top-items" v-else>
					<view class="user-top-item" @click="goNext('/my/link-up')">
						<text
							class="num-text">{{identity == 1 ? (user.chat_xm_count || 0) : (user.chat_jl_count || 0)}}</text>
						<text class="sub-text">沟通过</text>
					</view>
					<view class="user-top-item" @click="goNext('/pages/my/user-collect')">
						<text
							class="num-text">{{identity == 1 ? (user.collect_xm_count || 0) : (user.collect_jl_count || 0)}}</text>
				...
				<view class="user-top-bot">
					...
					<button size="mini" @click="goNext('/my/my-resume')"
						v-if="identity == 1">{{temp_user.btn_title}}</button>
