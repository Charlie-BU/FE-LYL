<template>
	<view class="container">
			...
			<view class="user-top">
				...
				<view class="my-top" v-if="user_id > 0">
					<view class="left" @click="toNext('/pages/my/user-personal')">
						<image :src="user.head_pic" mode="aspectFill" class="head-img"/>
					</view>
					<view class="center">
						<view class="center-nickname">
							<text class="nickname-text">{{user.nickname}}</text>
						</view>
						<view class="center-bot"  @click="toNext('/pages/my/user-personal')">
							<text>张三</text>
							<image src="@/static/my/bianji.png" mode="widthFix"/>
						</view>
					</view>
					<view class="right">
						<view class="right-item" @click="goNext('/my/change-identity')">
							<image src="@/static/my/change-identity.png" mode="widthFix"></image>
							<text>切换身份</text>
						</view>
						<!-- #ifdef MP-WEIXIN -->
						<button class="right-item" open-type="contact">
				...
				<view class="user-top-bot">
					<image src="@/static/my/wenjianjia.png" mode="widthFix"/>
					<view class="user-top-bot-center">
						<view class="tit">发布项目</view>
						<view class="sub-tit">千万招聘者的选择</view>
					</view>
					<button size="mini" @click="goNext('/pages/talents/publish')">去发布</button>
				</view>
			</view>
		<view class="info">
			<view class="info-title">我的项目</view>
			...
			<view class="items">
				<my-xm-items @itemClick="itemClick"></my-xm-items>
			</view>
		</view>
		...
		<my-zd-item :show="showZd" @select="selectZd"></my-zd-item>
	</view>
</template>
