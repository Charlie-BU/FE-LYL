					...
					<div class="right">
							...
							<div v-if="post.post_image.length>=1 && post.post_image.length<=3"
								...
								<div v-for="(image, i) in post.post_image" :key="i" class="image-item">
									<img v-if="image && image.length>=6" class="post-images"
										:src="image" @click.stop="image_operation(image)" />
								</div>
							</div>
						...
						<div style="text-align: end; margin-top: 30rpx;">
							<div style="display: inline-block; text-align: center; margin-right: 30rpx;"
								...
								<img v-if="post.liked" class="bottom-icon"
									src="../../static/square/like-after.jpg" />
								<img v-else class="bottom-icon"
									src="../../static/square/like-before.jpg" />
								<p style="font-size: 22rpx; color: #999999; margin: 0;">{{post.likes}}
								</p>
							</div>
							<div style="display: inline-block; text-align: center;"
								@click.stop="send_comment(post)">
			...
			<div class="modal">
				...
				<div class="form-group">
					...
					<div class="image-preview">
						<img v-for="(image, index) in preview_images" :key="index" :src="image"
							class="preview-image" @click="image_operation(image)" />
