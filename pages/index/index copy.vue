<template>
	<view class="container" :class="{'kefu': identity == 3}">
			...
			<template v-if="identity == 3">
				<view class="kefu-top">
					...
					<view class="kefu-search" v-if="form.type != ''">
						...
						<view class="search-right" @click.stop="goNext(`/pages/index/filter-list?from=1&is_filter=1&kf_type=${form.type}`)">
				...
				<scroll-view scroll-y="true" :style="{
					'height':form.type == 0 ? 'calc(100% - 88rpx)' : 'calc(100% - 108rpx - 64rpx)'
				}" class="kefu-scroll" @scrolltolower="getMore()">
					<view class="info">
						<view class="items">
		...
		<u-back-top v-if="false" :scroll-top="scrollTop" :customStyle="{'background':'#02ABAB'}" :iconStyle="{'color':'#fff'}"/>
